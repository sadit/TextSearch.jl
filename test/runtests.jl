...
include("testvariants.jl")
include("testedits.jl")
include("vec.jl")
include("svec.jl")
include("search.jl")
include("testqueryexpansion.jl")
include("testquerypipeline.jl")
include("textprofile.jl")
include("testprofileindex.jl")
include("testfitprofile.jl")
include("testdeprecated.jl")
include("testarraystore.jl")
include("testprofile.jl")
include("testlsistore.jl")
include("testmergeprofiles.jl")
include("testrefit.jl")
include("testreadme.jl")
include("fulltext.jl")
include("testlsi.jl")
